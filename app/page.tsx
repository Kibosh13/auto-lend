        ...
        <div className="mx-auto grid max-w-[1200px] gap-10 px-5 py-16 md:px-8 md:py-20 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-7 max-w-2xl text-sm leading-7 text-muted-foreground md:text-base">
              Вы также можете воспользоваться <a href="https://t.me/+qbH6dGRpqBQ1ZmNi" target="_blank" rel="noopener noreferrer" className="text-foreground underline decoration-border underline-offset-4">закрытым разделом</a> нашего издания, ориентированного на более широкое освещение рынка американского природного газа и нефти. В основе его работы лежит экспертная оценка отраслевых событий, авторские аналитические инструменты и индикаторы, а также оперативное информирование о новостях и факторах, влияющих на ценообразование нашего бенчмарка.
            </p>
          </div>
        </div>
      </section>
